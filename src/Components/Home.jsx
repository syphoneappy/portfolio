    ...
    <div  id="home" name='Home' className='flex h-screen bg-gradient-to-b from-black to-gray-800'>
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row mt-20'>
        <div className='flex flex-col justify-center h-full'>
            ...
            <a className='group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer' href={"external/resume.pdf"} download={true} target='_black' rel='noreferrer'>Resume <span className='group-hover:rotate-90 duration-300 ml-2'><ArrowForwardIosIcon /></span></a>
        </div>
